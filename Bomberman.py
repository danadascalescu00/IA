...
class Player:
    ...
    def has_died(self, opponent, game_map):
        ...
        for direction in directions:
            ...
            if game_map[new_pos[0]][new_pos[1]] == ' ' or game_map[new_pos[0]][new_pos[1]] == 'p':
                is_blocked = False
...
def draw_game(display, current_game):
    ...
    player1_img = pygame.image.load('C:\\Users\\Dana\\Desktop\\231_Dascalescu_Dana\\player1.png')
    player1_img = pygame.transform.scale(player1_img, (block_width, block_height))

    player2_img = pygame.image.load('C:\\Users\\Dana\\Desktop\\231_Dascalescu_Dana\\player2.png')
    player2_img = pygame.transform.scale(player2_img, (block_width, block_height))

    block_img = pygame.image.load('C:\\Users\\Dana\\Desktop\\231_Dascalescu_Dana\\block.png')
    block_img = pygame.transform.scale(block_img, (block_width, block_height))

    wall_img = pygame.image.load('C:\\Users\\Dana\\Desktop\\231_Dascalescu_Dana\\wall.png')
    wall_img = pygame.transform.scale(wall_img, (block_width, block_height))
    
    bomb_img = pygame.image.load('C:\\Users\\Dana\\Desktop\\231_Dascalescu_Dana\\bomb.png')
    bomb_img = pygame.transform.scale(bomb_img, (block_width, block_height))

    protection_img = pygame.image.load('C:\\Users\\Dana\\Desktop\\231_Dascalescu_Dana\\protection.png')
